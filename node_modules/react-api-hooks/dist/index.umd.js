(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.debounce'), require('react'), require('hash-object'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash.debounce', 'react', 'hash-object', 'axios'], factory) :
  (factory((global.reactApiHooks = {}),global.debounce,global.react,global.hash,global.axios));
}(this, (function (exports,debounce,react,hash,axios) {
  ...
  function useParams(initialParams, debounceWait) {
    ...
    var ref = react.useState(initialParams);
    var params = ref[0];
    var setParams = ref[1];
    ...
    var debouncedSetParams = react.useMemo(function () { return debounce(function (newParams) {
      setIsStale(false);
      setParams(newParams);
    }, debounceWait); }, []);
    return {
  ...
  exports.useInfAPI = useInfAPI;
  exports.getOffsetPaginator = getOffsetPaginator;
